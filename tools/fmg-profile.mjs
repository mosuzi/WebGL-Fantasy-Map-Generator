...
const outputJson = resolve(args.out || join(rootDir, "docs", "generated", "reports", "performance-baseline-results.json"));
const outputMd = resolve(args.markdown || join(rootDir, "docs", "generated", "reports", "performance-baseline-results.md"));
