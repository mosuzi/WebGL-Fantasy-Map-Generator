...
function verifyRegistryAndUiContract() {
  ...
  assert.match(cloudStyles, /background:\s*var\(--el-fill-color-light,\s*var\(--panel-surface\)\)/);
  assert.match(cloudStyles, /color:\s*var\(--el-text-color-secondary,\s*var\(--panel-text\)\)/);
  assert.match(cloudStyles, /\.cloud-storage-configuration code[\s\S]*background:\s*var\(--el-fill-color,\s*var\(--panel-surface\)\)/);
  assert.match(cloudStyles, /\.cloud-storage-file[\s\S]*background:\s*var\(--el-bg-color-overlay,\s*var\(--panel-surface\)\)/);
  assert.match(cloudStyles, /\.cloud-storage-file\.selected[\s\S]*border-color:\s*var\(--el-color-primary,/);
  assert.match(cloudStyles, /\.cloud-storage-status[\s\S]*var\(--el-color-success,/);
  assert.match(cloudStyles, /\.cloud-storage-error[\s\S]*var\(--el-color-danger,/);
