...
assert.equal(Object.values(API_METHODS).reduce((sum, methods) => sum + methods.length, 0), 325);
...
console.log(JSON.stringify({ok: true, methodCounts: {total: 325, edit: 179}, dynamic}, null, 2));
