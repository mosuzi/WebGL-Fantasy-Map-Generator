...
console.log(JSON.stringify({ok: true, viewShortcuts: 4, committedHighlight: true, singleIntent: true, viewportIndependentSurface: true, canonicalModes: true, progressThrottleMs: 80}));
