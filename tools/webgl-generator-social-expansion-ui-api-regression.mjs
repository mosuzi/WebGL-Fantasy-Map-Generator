...
assert.equal(Object.values(API_METHODS).reduce((sum, methods) => sum + methods.length, 0), 200);
assert.equal(API_METHODS.edit.length, 102);
...
console.log(JSON.stringify({ok: true, methodCounts: {total: 200, edit: 102}, dynamic}, null, 2));
