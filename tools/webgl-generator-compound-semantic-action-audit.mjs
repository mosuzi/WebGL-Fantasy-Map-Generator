...
const RULE_ACTIONS = Object.freeze([
  ...
  rule({
    ...
    title: "编辑区域高度并维护海陆边界",
    domain: "terrain",
    status: "existing-needs-inspector",
    intent: "按 Cell 集、范围或画笔修改高度，并明确是否影响海底及哪些派生系统待更新。",
    variants: ["raise", "lower", "level", "range-transform"],
    api: ["edit.height.applyChanges", "edit.height.inspectRangeTransform", "edit.height.applyRangeTransform"],
    inspect: "edit.height.inspectRangeTransform / planned:cells.inspectAction(height.edit)",
  ...
  rule({
    ...
    api: ["edit.rivers.create"],
    inspect: "planned:cells.inspectAction(river.add)",
  ...
  rule({
    ...
    inspect: "planned:edit.rivers.inspectDelete",
  ...
  rule({
    ...
    api: ["edit.lakes.create"],
    inspect: "planned:cells.inspectAction(lake.excavate)",
  ...
  rule({
    ...
    inspect: "planned:edit.lakes.inspectDelete",
  ...
  rule({
    ...
    api: ["edit.biomes.assignCells"],
    inspect: "planned:cells.inspectAction(biome.assign)",
  ...
  rule({
    ...
    api: ["edit.states.add"],
    inspect: "planned:edit.states.inspectCreateAtCell",
    execute: "planned:edit.states.createAtCell",
  ...
  rule({
    ...
    inspect: "planned:edit.states.inspectDelete",
  ...
  rule({
    ...
    api: ["edit.provinces.add"],
    inspect: "planned:edit.provinces.inspectCreateAtCell",
    execute: "planned:edit.provinces.createAtCell",
  ...
  rule({
    ...
    inspect: "planned:edit.provinces.inspectDelete",
  ...
  rule({
    ...
    api: ["objects.get", "cells.query"],
    inspect: "planned:edit.provinces.inspectMerge",
    execute: "planned:edit.provinces.merge",
  ...
  rule({
    ...
    api: ["objects.get", "cells.query"],
    inspect: "planned:edit.provinces.inspectSplit",
    execute: "planned:edit.provinces.split",
  ...
  rule({
    ...
    api: ["edit.states.setCapital"],
    inspect: "planned:edit.states.inspectCapitalChange",
  ...
  rule({
    ...
    api: ["edit.cities.add"],
    inspect: "planned:edit.cities.inspectCreateAtCell",
    execute: "planned:edit.cities.createAtCell",
  ...
  rule({
    ...
    inspect: "planned:edit.cities.inspectDelete",
  ...
  rule({
    ...
    api: ["edit.cities.syncOwner"],
    inspect: "planned:edit.cities.inspectOwnerSync",
  ...
  rule({
    ...
    api: ["namebases.bind", "namebases.renameObjects"],
    inspect: "planned:namebases.inspectBindAndRename",
    execute: "planned:namebases.bindAndRename",
  ...
  rule({
    ...
    api: ["namebases.import", "namebases.update", "namebases.delete", "namebases.clear", "namebases.bind"],
    inspect: "planned:namebases.inspectReplacement",
    execute: "planned:namebases.replace",
  ...
  rule({
    ...
    inspect: "planned:edit.routes.inspectDelete",
  ...
  rule({
    ...
    api: ["edit.zones.create", "edit.zones.delete"],
    inspect: "planned:cells.inspectAction(zone.add) / planned:edit.zones.inspectDelete",
  ...
  rule({
    ...
    api: ["edit.diplomacy.setRelation"],
    inspect: "planned:edit.diplomacy.inspectRelation",
  ...
  rule({
    ...
    api: ["objects.get"],
    inspect: "planned:edit.diplomacy.inspectDeclareWar",
    execute: "planned:edit.diplomacy.declareWar",
  ...
  rule({
    ...
    api: ["objects.get", "edit.diplomacy.setRelation"],
    inspect: "planned:edit.diplomacy.inspectPeace",
    execute: "planned:edit.diplomacy.makePeace",
  ...
  rule({
    ...
    api: ["objects.get", "edit.diplomacy.setRelation"],
    inspect: "planned:edit.diplomacy.inspectOverlordChange",
    execute: "planned:edit.diplomacy.changeOverlord",
  ...
  rule({
    ...
    api: ["edit.military.setRatios"],
    inspect: "planned:edit.military.inspectRatios",
  ...
  rule({
    ...
    api: ["edit.military.moveStation"],
    inspect: "planned:cells.inspectAction(military.move)",
  ...
  rule({
    ...
    api: ["edit.military.setBase"],
    inspect: "planned:edit.military.inspectBase",
  ...
  rule({
    ...
    variants: ["single", "batch"],
    api: ["edit.military.setStatus", "edit.military.setStatusBatch"],
    inspect: "planned:edit.military.inspectStatus",
  ...
  rule({
    ...
    api: ["edit.notes.import", "edit.measurements.import", "namebases.import", "edit.military.importBattleEvents"],
    inspect: "planned:data.inspectCollectionImport",
...
function socialRule(kind, label) {
  ...
  return rule({
    ...
    inspect: `edit.${plural}.inspectExpansion / planned:edit.${plural}.inspectLifecycle`,
    execute: `edit.${plural}.*`,
