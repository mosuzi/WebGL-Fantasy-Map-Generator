...
- Vue 浮动面板：控制面板、高度编辑、国家编辑、省份管理、城市管理、文化管理、宗教管理、外交管理、路线管理、河流管理、资源标记、标签管理和备注总览。
...
- 中文命名继续细化：当前已加入春秋古国风短名和单字国名策略，并对群舒、曾/鄫/缯、谭/郯等近源根名做家族去重；后续继续打磨文化差异、避讳规则和更稳定的省份/城市命名联动。
