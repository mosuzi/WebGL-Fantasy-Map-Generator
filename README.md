...
- 轻量编辑能力：可以调整部分对象名称、颜色、政体（含分组批量套用）、首都、城市剪影、资源点、外交关系、军事态势、驻地/基地、兵种比例和高度编辑笔刷；国家、城市和河流可按当前名称库对筛选结果执行显式重命名，选中的国家/城市标签也可只重命名对应目标并撤销。
...
- 名称库后续主要把显式重命名扩展到湖泊等更多对象，并补更多质量参数；导入、绑定、本地偏好、样例预览、权重、Markov 链路、撤销/重做、国家/城市/河流筛选显式重命名，以及选中标签目标单个重命名已经完成。
