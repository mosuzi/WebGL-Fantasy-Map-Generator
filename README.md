...
- 轻量编辑能力：可以调整部分对象名称、颜色、政体（含分组批量套用）、首都、城市剪影、资源点、外交关系、军事态势、驻地/基地、兵种比例和高度编辑笔刷；城市可按当前名称库对筛选结果执行显式重命名并撤销。
...
- 名称库后续主要把显式重命名扩展到国家、河流、湖泊等更多对象，并补更多质量参数；导入、绑定、本地偏好、样例预览、权重、Markov 链路、撤销/重做和城市显式重命名第一刀已经完成。
