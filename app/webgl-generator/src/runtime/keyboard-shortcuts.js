...
export const KEYBOARD_SHORTCUTS = Object.freeze([
  ...
  shortcut({id: "view.height", group: "view", label: "高度视图", scope: "global", when: "map-idle", selector: ".view-mode-segmented .el-segmented__item:nth-of-type(1)", bindings: [binding("Digit1", {shift: true})], action: {type: "api", path: "layers.setViewMode", args: ["height"]}}),
  shortcut({id: "view.biomes", group: "view", label: "生物群系视图", scope: "global", when: "map-idle", selector: ".view-mode-segmented .el-segmented__item:nth-of-type(4)", bindings: [binding("Digit2", {shift: true})], action: {type: "api", path: "layers.setViewMode", args: ["biomes"]}}),
  shortcut({id: "view.diplomacy", group: "view", label: "外交视图", scope: "global", when: "map-idle", selector: ".view-mode-segmented .el-segmented__item:nth-of-type(7)", bindings: [binding("Digit3", {shift: true})], action: {type: "api", path: "layers.setViewMode", args: ["diplomacy"]}}),
  shortcut({id: "view.states", group: "view", label: "国家视图", scope: "global", when: "map-idle", selector: ".view-mode-segmented .el-segmented__item:nth-of-type(9)", bindings: [binding("Digit4", {shift: true})], action: {type: "api", path: "layers.setViewMode", args: ["states"]}}),
