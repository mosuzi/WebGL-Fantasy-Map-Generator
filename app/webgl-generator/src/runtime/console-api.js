...
export function buildMethodMetadata() {
  return {
    ...
    history: {
      ...
      undo: {stable: "draft", mutates: "map-and-edit-history-state", undoable: false, async: true, requiresConfirm: false},
      redo: {stable: "draft", mutates: "map-and-edit-history-state", undoable: false, async: true, requiresConfirm: false}
    },
    selection: {
      get: {stable: "draft", mutates: "none", undoable: false, async: false, requiresConfirm: false},
    ...
    edit: {
      ...
      "cities.inspectMove": {stable: "draft", mutates: "none", undoable: false, async: true, requiresConfirm: false},
      "cities.move": {stable: "draft", mutates: "settlements-routes", undoable: true, async: true, requiresConfirm: false},
      ...
      "height.rebuildBaseDerived": {stable: "draft", mutates: "map-derived-data", undoable: true, async: true, requiresConfirm: true},
      "height.rebuildDownstreamDerived": {stable: "draft", mutates: "map-derived-data", undoable: true, async: true, requiresConfirm: true},
      "height.rebuildAllDerived": {stable: "draft", mutates: "map-derived-data", undoable: true, async: true, requiresConfirm: true},
      ...
      "population.applyAdjustment": {stable: "draft", mutates: "population-and-economy-demand", undoable: true, async: true, requiresConfirm: false},
      "population.inspectTransfer": {stable: "draft", mutates: "none", undoable: false, async: false, requiresConfirm: false},
      "population.transfer": {stable: "draft", mutates: "population-and-economy-demand", undoable: true, async: true, requiresConfirm: true},
      "economy.inspectAssignment": {stable: "draft", mutates: "none", undoable: false, async: false, requiresConfirm: false},
      "economy.assignCells": {stable: "draft", mutates: "economy", undoable: true, async: true, requiresConfirm: true},
      "economy.rebuild": {stable: "draft", mutates: "economy", undoable: true, async: true, requiresConfirm: true},
      ...
      "cultures.applyExpansion": {stable: "draft", mutates: "cultures-and-derived-stale", undoable: true, async: true, requiresConfirm: false, conditionalConfirm: "mode=reexpand"},
      ...
      "religions.applyExpansion": {stable: "draft", mutates: "religions-and-derived-stale", undoable: true, async: true, requiresConfirm: false, conditionalConfirm: "mode=reexpand"},
      ...
      "routes.create": {stable: "draft", mutates: "routes", undoable: true, async: true, requiresConfirm: false},
      "routes.inspectEdit": {stable: "draft", mutates: "none", undoable: false, async: true, requiresConfirm: false},
      "routes.update": {stable: "draft", mutates: "routes", undoable: true, async: true, requiresConfirm: false},
