...
export const API_METHODS = Object.freeze({
  ...
  edit: Object.freeze([
    ...
    "provinces.add", "provinces.inspectCreateAtCell", "provinces.createAtCell", "provinces.inspectDelete", "provinces.delete", "provinces.inspectEnsureAssignment", "provinces.ensureAssignment", "provinces.inspectTransfer", "provinces.transfer", "provinces.rename", "provinces.setColor", "provinces.applyChanges",
