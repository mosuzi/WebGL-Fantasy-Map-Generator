...
export const API_METHODS = Object.freeze({
  ...
  edit: Object.freeze([
    ...
    "provinces.add", "provinces.inspectCreateAtCell", "provinces.createAtCell", "provinces.inspectDelete", "provinces.delete", "provinces.inspectEnsureAssignment", "provinces.ensureAssignment", "provinces.inspectTransfer", "provinces.transfer", "provinces.inspectMerge", "provinces.merge", "provinces.inspectSplit", "provinces.split", "provinces.inspectCapitalReassessment", "provinces.reassessCapitals", "provinces.rename", "provinces.setColor", "provinces.applyChanges",
    ...
    "zones.inspectCreate", "zones.create", "zones.inspectDelete", "zones.delete", "zones.setStyle", "zones.setContext", "zones.setProperties", "zones.getEffectsAtCell",
  ...
  data: Object.freeze(["exportAll", "exportMap", "exportGEO", "exportFeatureGEO", "exportCompressedAll", "exportPNG", "exportHeightmapPNG", "exportNotes", "exportMeasurements", "exportImportDiagnostic", "saveBrowserMap", "restoreBrowserMap", "inspectCollectionImport", "importMap", "importGEO", "importHeightmap"]),
