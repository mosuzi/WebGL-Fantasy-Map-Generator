...
export const API_METHODS = Object.freeze({
  ...
  edit: Object.freeze([
    ...
    "cities.add", "cities.inspectCreateAtCell", "cities.createAtCell", "cities.inspectDelete", "cities.delete", "cities.inspectMove", "cities.move", "cities.rename", "cities.setPopulation", "cities.syncOwner", "cities.setVisual", "cities.resetVisual",
    ...
    "states.add", "states.inspectCreateAtCell", "states.createAtCell", "states.inspectDelete", "states.delete", "states.inspectMerge", "states.merge", "states.inspectSplit", "states.split", "states.rename", "states.setColor", "states.setGovernment", "states.setCapital", "states.setGovernmentBatch", "states.applyChanges",
    "height.inspectChanges", "height.applyChanges", "height.inspectGlobalTransform", "height.applyGlobalTransform", "height.inspectTerrainTemplate", "height.applyTerrainTemplate", "height.inspectTerrainProgram", "height.applyTerrainProgram", "height.inspectRangeTransform", "height.applyRangeTransform", "height.inspectSelectionSmoothing", "height.applySelectionSmoothing", "height.inspectSeafloorReset", "height.applySeafloorReset", "height.rebuildBaseDerived", "height.rebuildDownstreamDerived", "height.rebuildAllDerived", "biomes.inspectAssignment", "biomes.assignCells", "biomes.inspectSuitability", "biomes.applySuitability", "population.inspectAdjustment", "population.applyAdjustment", "population.inspectTransfer", "population.transfer", "diplomacy.setRelation",
