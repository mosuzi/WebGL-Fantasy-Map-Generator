...
const OBJECT_TITLE_FORMATTERS = Object.freeze({
  ...
  [OBJECT_KIND.DIPLOMACY_RELATION]: object => `外交 ${object.subjectName || `#${object.subjectId}`} -> ${object.objectName || `#${object.objectId}`}`,
...
const OBJECT_DETAIL_FORMATTERS = Object.freeze({
  ...
  [OBJECT_KIND.DIPLOMACY_RELATION]: object => `${object.relationLabel || object.relation || "未知"} / ${object.subjectName || `#${object.subjectId}`} -> ${object.objectName || `#${object.objectId}`}`,
...
export function bindRuntimePanel(documentRef, handlers) {
  ...
  documentRef.getElementById("open-feature-panel")?.addEventListener("click", handlers.onOpenFeaturePanel);
  ...
  documentRef.getElementById("export-map-import-diagnostic")?.addEventListener("click", () => handlers.onExportMapImportDiagnostic?.());
...
function editLockControls(documentRef) {
  return documentRef.querySelectorAll([
    ...
    "#export-png-crop-x",
    "#export-png-crop-y",
    "#export-png-crop-width",
    "#export-png-crop-height",
    "#export-png-overlays",
    "#export-png-transparent",
    "#export-png-overlay-labels",
    "#export-png-overlay-city-icons",
    "#export-png-overlay-markers",
    "#export-png-overlay-military",
    "#export-png-overlay-measurements",
    "#export-png-overlay-legend",
    "#export-png-overlay-scale-bar",
    "#export-map-data",
    "#export-map-data-compressed",
    "#export-map-geojson",
    ...
    "#geojson-export-range-mode",
    "#geojson-export-bbox-min-x",
    "#geojson-export-bbox-min-y",
    "#geojson-export-bbox-max-x",
    "#geojson-export-bbox-max-y",
    "#import-map-file",
...
function normalizeControlPreferences(preferences) {
  ...
  delete normalized.navigationInputMode;
