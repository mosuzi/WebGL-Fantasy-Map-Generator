...
export function createRiverPanel(documentRef, manager, callbacks = {}) {
  ...
  const panelCallbacks = {
    ...
    onApplyWaypoint: () => callbacks.onApplyWaypoint?.(),
    onReselectWaypoint: () => callbacks.onReselectWaypoint?.(),
    onCancelWaypoint: () => callbacks.onCancelWaypoint?.(),
  ...
  return {
    ...
    setWaypointFeedback(feedback) {
      panelState.waypointFeedback = feedback ? markRaw(feedback) : null;
      panelState.version++;
    },
    isOpen() {
