...
export function createStatePanel(documentRef, manager, callbacks = {}) {
  ...
  const panelCallbacks = {
    ...
    onProvinceSuffixChange: (stateId, formName, overwriteCustom) => callbacks.onProvinceSuffixChange?.(stateId, formName, overwriteCustom),
    ...
    onMerge: options => callbacks.onMerge?.(options),
    onInspectSplit: options => callbacks.onInspectSplit?.(options),
    onSplit: options => callbacks.onSplit?.(options),
