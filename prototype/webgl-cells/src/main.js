...
const editorElements = {
  ...
  heightFalloff: document.getElementById("height-falloff"),
  riverAction: document.getElementById("river-action"),
  riverWidth: document.getElementById("river-width"),
  riverFilter: document.getElementById("river-filter"),
  riverList: document.getElementById("river-list"),
  riverSummary: document.getElementById("river-summary"),
  stateColor: document.getElementById("state-color"),
  stateRadius: document.getElementById("state-radius"),
