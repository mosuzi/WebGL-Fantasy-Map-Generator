...
然后只按 `docs/current-plan.md` 的活动权威任务继续。当前第 28～52、54～178 项已完成，权威任务清单为空；不得从历史里程碑、README、FOLLOWUPS 或专题文档的“下一步”自行创造任务，`Q-25～Q-33` 仍是未批准候选。第 174 项指定 PNG 印面的旧纸自卷画轴已在第 176 项迁入正式 APP，并在第 178 项改为合成友好的展开路径；独立 prototype 继续作为视觉基线。
