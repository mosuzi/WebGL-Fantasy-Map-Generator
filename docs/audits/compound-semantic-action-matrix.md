...
| `diplomacy.make-peace` | 外交、战争与国家关系 | 结束战争，同步战后关系、军队状态和纪事；可附文本备注。 | `existing-transaction` | `edit.diplomacy.inspectPeace`<br>`edit.diplomacy.makePeace`<br>`objects.get` | `edit.diplomacy.inspectPeace`<br>`edit.diplomacy.makePeace` |
