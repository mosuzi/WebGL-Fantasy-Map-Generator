...
> **2026-08-09 最终状态**：用户在 2026-08-08 推翻的新增、拖动、双击删除、同 cell 和曲线几何结论，已经由完成并归档的第 305 项纠正并通过独立终审。本文件以下内容只保存第 303 项当时的历史方案与证据；当前实现和验收以第 305 项及 [`第 304～306 项重新调查报告`](./task-304-306-river-city-reinvestigation.md) 为准。
