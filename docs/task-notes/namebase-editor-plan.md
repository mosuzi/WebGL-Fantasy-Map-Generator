...
本文档记录对照原版 `Namesbase Editor` 后，WebGL 版名称库能力的实现边界。当前生成器已有中文词池、春秋古国风国家根名和标签管理，也已具备用户名称库导入导出、编辑、全局绑定、文化级绑定和文化面板快捷入口；后续重点是权重、链路质量和更接近原版的 Markov 生成。
...
- 补链路多样性、权重、应用级用户库偏好和更接近原版的 Markov 生成质量。
