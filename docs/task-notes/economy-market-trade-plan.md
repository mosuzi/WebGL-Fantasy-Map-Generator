...
- 权威任务第 92 项已完成经济面板按需查询：按国家、行政区域、市场、商品、卖方、买方组合筛选交易并定位关联对象。
...
- 经济交易数据、经济总览、交易筛选排序和详情字段保留；经济面板交易 tab 已支持国家、行政区域、市场、商品、卖方和买方的结构化组合条件，并与自由文本、限量渲染、结果计数、CSV / JSON 导出和当前交易关联定位共用同一查询结果。后续仍应把贸易查看收敛到列表或按需查询，而不是继续叠地图连线。
