...
14. README 当前状态刷新已完成：根目录 README 已补“已经完成 / 还要做”，把生成、编辑、导入导出、贸易外交军事、性能与 WebGL 化进展写成读者向状态；最新刷新已把战斗事件记录、导入、筛选、清理、完整链路展开、摘要和导出移入已完成范围，后续军事待办收敛为战争行动链路、双方结算、战役推进和经济/外交联动。
