...
控制台 / 扩展 API 系统的权威任务第 28～44 项、曲线尺第 45 项、备注治理第 46 项、名称库收尾第 47 项、市场归属第 48 项、路线编辑第 49 项、水体与 feature 局部修正第 50 项、生物群系局部编辑第 51 项、用户主题第 52 项和界面审计整改第 55～60 项已经全部完成并移出活动清单。现在执行第 54 项；原第 53 项已按用户决定移除，短期不深化纹章系统。
...
> **执行门禁（2026-07-15）**：用户已批准按目标模式实施。第 45～52、55～60 项均已达到最小验收并移出活动清单；现在执行第 54 项。
...
- **权威任务第 54 项：GeoJSON 范围导出与坐标参考强化。** `执行中；来源：export-capability-matrix`
...
第 45～52、55～60 项已完成并移出活动清单；当前执行第 54 项。第 53 项已移除且不作为隐含待办。
