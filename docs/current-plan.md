...
2. marker 后续不要为了单个类型继续扩大总量；如果继续深化，应进入 marker 面板、资源点编辑、marker 局部重算、文化化图标预设和城镇标识复用，而不是再调全局 target。可追加的资源点类型包括：采石场、黏土坑、煤田、硫磺泉、硝石洞、琥珀海岸、珍珠滩、珊瑚礁、渔场、良港、森林木场、树脂林、药草谷、染料草场、香料林、茶山、丝茧桑园、马场、牧盐草甸、绿洲、圣泉、地热田。
